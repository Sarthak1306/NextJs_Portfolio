  ...
  const experiences = [
    {
      ...
      company_name: "LagaLand LLP",
      icon: lagaland,
      iconBg: "#383E56",
      date: "June 2022 - Aug 2022",
      points: [
        "Developing the frontend for a search engine application using React.js and other related technologies.",
    ...
    },
    {
      ...
      company_name: "DKG Labs",
      icon: dkg,
      iconBg: "#383E56",
      date: "July 2023 - April 2024",
      points: [
        "Created dynamic AI solutions for customer service applications.",
        "Conducted research on emerging technologies related to artificial intelligence engineering.",
        "Developed APIs for integrating third-party AI services into existing applications."
      ],
    },
    {
      title: "AI/Web Developer",
      company_name: "Software Technology Parks of India (MeitY)",
      icon: stpi,
      iconBg: "#E6DEDD",
      date: "April 2024 - Present",
      points: [
        "Developeding and maintaining websites, portals, and large-scale web applications for multiple clients.",
